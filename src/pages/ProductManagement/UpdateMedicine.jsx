...
const UpdateMedicine = (props, { shopId }) => {
  ...
  const showEditModal = () => {
    ...
    form.setFieldsValue({
      ...
      dosageForm: record.dosageForm, // New field
      symptoms: record.symptoms, // New field
    });
    setIsEditOpen(true);
  };
  ...
  const handleEditSubmit = () => {
    form.validateFields().then((values) => {
      ...
      const formattedValues = {
        ...
        dosageForm: values.dosageForm, // New field
        symptoms: values.symptoms, // New field
      };
      ...
      dispatch(
        updateMedicineManagement({
          updatedMedicine: formattedValues,
        })
      )
        .unwrap()
        .then(() => {
