      ...
      >
        <Form form={form} onFinish={onFinish}>
            ...
            <Col>
              ...
              >
                <Select placeholder="Select Type">
                  <Select.Option value={0}>Viral</Select.Option>
                  <Select.Option value={1}>Bacterial</Select.Option>
                  <Select.Option value={2}>Fungal</Select.Option>
                </Select>
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row style={{ justifyContent: "space-between" }}>
            ...
            {/* 3rd column */}
            <Col>
              <p className="modalContent">Medicines</p>
              <Form.Item
                name="medicineIds"
                rules={[
                  {
